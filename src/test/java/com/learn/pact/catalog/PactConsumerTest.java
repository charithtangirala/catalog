...
public class PactConsumerTest {
    ...
    @Pact(provider = "inventory", consumer = "catalog")
    public RequestResponsePact getValidInventory(final PactDslWithProvider builder) throws IOException {
        ...
        return builder
                ...
                .body("{\"items\":[{\"id\":\"ITEM_ID_1\",\"name\":\"ITEM_NAME_1\",\"quantity\":\"200\",\"backOrder\":\"100\"},{\"id\":\"ITEM_ID_2\",\"name\":\"ITEM_NAME_2\",\"quantity\":\"50\",\"backOrder\":\"0\"},{\"id\":\"ITEM_ID_3\",\"name\":\"ITEM_NAME_3\",\"quantity\":\"600\",\"backOrder\":\"500\"}]}")
                .toPact();
    }
